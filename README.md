...
Basada en un ESP32-S3, con 16 bancos 3x16 pulsadores y dos potenciómetros (conectados via jack stereo), para interactuar en directo con tu DAW favorito de una forma mas vistosa que con un MPKmini.
...
LEDs: SIEMPRE con resistencia (220Ω-330Ω) en serie
```
